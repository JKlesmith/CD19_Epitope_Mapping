...
mask_drop = (
        ...
        (df_pact['4G7_20nm_Epitope_Drop_ref_counts'] >= 12)
        )
...
# plot the estimate
plt.figure(figsize=(8,8))
plt.scatter(df_masked['FMC63_Epitope_Drop_sd_from_wt'], 
            df_masked['FMC63_20nm_Epitope_Drop_sd_from_wt'], s=4, color='red')
plt.ylabel('4G7')
plt.xlabel('FMC')
plt.show()


all_20 = df_masked['FMC63_20nm_Epitope_Drop_sd_from_wt']
all_pm = df_masked['FMC63_Epitope_Drop_sd_from_wt']