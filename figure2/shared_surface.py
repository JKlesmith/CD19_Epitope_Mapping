...
mask_drop = (
        ...
        (df_pact['4G7_Epitope_Drop_classified'] != 'UNK') &        
...
for loc in np_locations:
    ...
    count_win = np.count_nonzero(df_loc['4G7_Epitope_Drop_sd_from_wt'] > 2)
    
    # get the number of obs
    count_obs = df_loc['4G7_Epitope_Drop_sd_from_wt'].shape[0]
